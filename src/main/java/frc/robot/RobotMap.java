...
public class RobotMap {
  ...
  // Shoooter
    public static final int SHOOTER_LEADER = 31;
    public static final int SHOOTER_FOLLOWER = 33;
  
    // Elevator
    public static final int ELEVATOR_NEO = 34;

    //Hopper

    public static final int HOPPER_NEO = 32;
    //Drivetrain
