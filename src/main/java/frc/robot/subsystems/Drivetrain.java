...
import frc.robot.commands.AdjustLimelight;
...
public class Drivetrain extends Subsystem{
    ...
    protected DifferentialDrive shakyDrive;
	...
	public Drivetrain(){
		...
		//Uses the Sparks to create a DifferentialDrive (it has methods that allow for easier control of the whole drivetrain at once)
		shakyDrive = new DifferentialDrive(leftSpark, rightSpark);
		shakyDrive.setSafetyEnabled(false);
